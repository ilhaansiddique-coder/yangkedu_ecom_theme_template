...
import { Star, ShoppingCart, Zap, ShieldCheck, Truck, Users } from "lucide-react";
import { useCart } from "@/lib/cart";
import { useCartUI } from "@/lib/cart-ui";
import { useProductBuy, lineFor } from "@/lib/product-buy";
import VariantPicker from "./VariantPicker";
import { money, soldLabel } from "@/lib/format";
import { type Product, productRating, productReviewCount } from "@/lib/products";
...
export default function ProductPanel({ product }: { product: Product }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <button type="button" onClick={scrollToReviews} className="flex w-fit items-center gap-2 text-[13px]">
